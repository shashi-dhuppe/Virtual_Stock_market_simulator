	...
	var chart = new CanvasJS.Chart("chartContainer",
	{
		...
		{        
			...
			dataPoints: [
				...
				{ x: new Date(2017,1,3), y: 20 },
				{ x: new Date(2017,2,3), y: 21 },
				{ x: new Date(2017,3,3), y: 21 },
				{ x: new Date(2017,4,3), y: 20 },
				{ x: new Date(2017,5,3), y: 22 },
				{ x: new Date(2017,6,3), y: 21 },
				{ x: new Date(2017,7,3), y: 20 },
				{ x: new Date(2017,8,3), y: 20 },
				{ x: new Date(2017,9,3), y: 21 }
			]
		...
		{        
			...
			name: "Low",
			dataPoints: [
				{ x: new Date(2017,0,3), y: 20 },
				{ x: new Date(2017,1,3), y: 19 },
				{ x: new Date(2017,2,3), y: 19 },
				{ x: new Date(2017,3,3), y: 20 },
				{ x: new Date(2017,4,3), y: 19 },
				{ x: new Date(2017,5,3), y: 21 },
				{ x: new Date(2017,6,3), y: 20 },
				{ x: new Date(2017,7,3), y: 19 },
				{ x: new Date(2017,8,3), y: 19 },
				{ x: new Date(2017,9,3), y: 20},
			]
		}
		]         
	});
...
<div id="main">
	...
	<div class="col-md-8">
		...
		<p align="justify">KeyBank, the primary subsidiary of KeyCorp, is a regional bank headquartered in Cleveland, Ohio, and is the only major bank based in Cleveland. KeyBank is 
		on the list of largest banks in the United States.
		Key's customer base spans retail, small business, corporate, and investment clients. KeyBank maintains 1,217 branches and 1,500 ATMs, which are in Alaska, Colorado,
		Connecticut, Florida, Idaho, Indiana, Maine, Massachusetts, Michigan, New York, Ohio, Oregon, Pennsylvania, Utah, Vermont, and Washington. KeyCorp maintains business offices 
		in 31 states.</p>
