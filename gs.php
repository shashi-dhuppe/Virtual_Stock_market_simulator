...
window.onload = function () {
	var chart = new CanvasJS.Chart("chartContainer",
	{
		...
		{        
			...
			name: "High",
			dataPoints: [
				{ x: new Date(2017,0,3), y: 256 },
				{ x: new Date(2017,1,3), y: 259 },
				{ x: new Date(2017,2,3), y: 269 },
				{ x: new Date(2017,3,3), y: 265 },
				{ x: new Date(2017,4,3), y: 273 },
				{ x: new Date(2017,5,3), y: 270 },
				{ x: new Date(2017,6,3), y: 271 },
				{ x: new Date(2017,7,3), y: 261 },
				{ x: new Date(2017,8,3), y: 264 },
				{ x: new Date(2017,9,3), y: 267 }
			]
		...
		{        
			...
			name: "Low",
			dataPoints: [
				{ x: new Date(2017,0,3), y: 248 },
				{ x: new Date(2017,1,3), y: 251 },
				{ x: new Date(2017,2,3), y: 254 },
				{ x: new Date(2017,3,3), y: 260 },
				{ x: new Date(2017,4,3), y: 268 },
				{ x: new Date(2017,5,3), y: 261 },
				{ x: new Date(2017,6,3), y: 253 },
				{ x: new Date(2017,7,3), y: 248 },
				{ x: new Date(2017,8,3), y: 249 },
				{ x: new Date(2017,9,3), y: 255},
			]
		}
		]         
	});
...
<div id="main">
	...
	<div class="col-md-8">
		<h1>Goldman Sachs Group Inc.</h1>
		<h3>Finance Company</h3>
		<p align="justify">The Goldman Sachs Group, Inc. is an American multinational finance company that engages in global investment banking, investment management, securities, 
		and other financial services including asset management, mergers and acquisitions advice, prime brokerage, and securities underwriting services. It also sponsors private 
		equity funds, is a market maker, and is a primary dealer in the United States Treasury security market. Goldman Sachs also owns GS Bank USA, a direct bank.</p>
		<div class="box" id="bord">
				<h2>Goldman Sachs Group Inc.</h2>
