		...
		<div class="col-md-12">
				...
				<div class="col-md-8" id="bord">
					...
					<table class="data-table">
						<caption class="title"><h2>Your stocks</h2></caption>
						<thead>
							<tr>
								<th>No.</th>
								<th>Id</th>
								<th>Stock name</th>
								<th>Buying cost for one share</th>
								<th>Current cost of one share</th>
								<th>Number of shares</th>
								<th>Total current cost</th>
								<th><span class="glyphicon glyphicon-triangle-top green"></span>/<span class="glyphicon glyphicon-triangle-bottom red"></span></th>
								<th></th>
							</tr>
						</thead>
						<tbody>
								...
								while ($row = mysql_fetch_assoc($sql))
								{
									...
									$amt=$amt+$total;
										echo '<tr>
											...
											<td>'.$total.'</td>
											<td>'.$fin.'</td>
											<td> <form action=sell.php>
												<input name=id type=hidden value='.$row['sid'].'>					
							...
							echo '<tr>
								<td colspan="5"></td>
								<td>Total cost of all shares</td>
								<td>'.$amt.'</td>
							</tr>'
							?>
						</tbody>
