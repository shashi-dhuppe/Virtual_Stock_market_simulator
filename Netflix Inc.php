...
window.onload = function () {
	var chart = new CanvasJS.Chart("chartContainer",
	{
		...
		{        
			...
			name: "High",
			dataPoints: [
				{ x: new Date(2017,0,3), y: 194 },
				{ x: new Date(2017,1,3), y: 195 },
				{ x: new Date(2017,2,3), y: 193 },
				{ x: new Date(2017,3,3), y: 194 },
				{ x: new Date(2017,4,3), y: 192 },
				{ x: new Date(2017,5,3), y: 190 },
				{ x: new Date(2017,6,3), y: 194 },
				{ x: new Date(2017,7,3), y: 190 },
				{ x: new Date(2017,8,3), y: 192 },
				{ x: new Date(2017,9,3), y: 195 }
			]
		...
		{        
			...
			name: "Low",
			dataPoints: [
				{ x: new Date(2017,0,3), y: 184 },
				{ x: new Date(2017,1,3), y: 180 },
				{ x: new Date(2017,2,3), y: 179 },
				{ x: new Date(2017,3,3), y: 176 },
				{ x: new Date(2017,4,3), y: 181 },
				{ x: new Date(2017,5,3), y: 183 },
				{ x: new Date(2017,6,3), y: 181 },
				{ x: new Date(2017,7,3), y: 175 },
				{ x: new Date(2017,8,3), y: 179 },
				{ x: new Date(2017,9,3), y: 181 },
				{ x: new Date(2017,10,3), y: 182 },
				{ x: new Date(2017,11,3), y: 177}
			]
		}
		]         
	});
...
<div id="main">
	...
	<div class="col-md-8">
		...
		<p align="justify">Netflix, is an American entertainment company founded by Reed Hastings and Marc Randolph on August 29, 1997, in Scotts Valley, California. It specializes 
		in and provides streaming media and video-on-demand online and DVD by mail. In 2013, Netflix expanded into film and television production as well as online distribution. It 
		is headquartered in Los Gatos, California.
		Netflix's initial business model included DVD sales and rental, although Hastings jettisoned DVD sales about a year after Netflix's founding to focus on the DVD rental by 
		mail business. In 2007, Netflix expanded its business with the introduction of streaming media, while retaining the DVD and Blu-ray Disc rental service. The company expanded
		internationally, with streaming made available to Canada in 2010 and continued growing its streaming service from there; by January 2016, Netflix services operated in over
		190 countries.</p>
