...
window.onload = function () {
	var chart = new CanvasJS.Chart("chartContainer",
	{
		...
		{        
			...
			name: "High",
			dataPoints: [
				{ x: new Date(2017,0,3), y: 376 },
				{ x: new Date(2017,1,3), y: 379 },
				{ x: new Date(2017,2,3), y: 381 },
				{ x: new Date(2017,3,3), y: 377 },
				{ x: new Date(2017,4,3), y: 379 },
				{ x: new Date(2017,5,3), y: 380 },
				{ x: new Date(2017,6,3), y: 381 },
				{ x: new Date(2017,7,3), y: 380 },
				{ x: new Date(2017,8,3), y: 382 },
				{ x: new Date(2017,9,3), y: 379 }
			]
		...
		{        
			...
			name: "Low",
			dataPoints: [
				{ x: new Date(2017,0,3), y: 371 },
				{ x: new Date(2017,1,3), y: 374 },
				{ x: new Date(2017,2,3), y: 375 },
				{ x: new Date(2017,3,3), y: 373 },
				{ x: new Date(2017,4,3), y: 375 },
				{ x: new Date(2017,5,3), y: 374 },
				{ x: new Date(2017,6,3), y: 373 },
				{ x: new Date(2017,7,3), y: 372 },
				{ x: new Date(2017,8,3), y: 374 },
				{ x: new Date(2017,9,3), y: 372},
			]
		}
		]         
	});
...
<div id="main">
	...
	<div class="col-md-8">
		...
		<p align="justify">Tesla, Inc. is an American company that specializes in electric automotives, energy storage and solar panel manufacturing based in Palo Alto, California.
		...
		The additional products Tesla sells include the Tesla Powerwall and Powerpack batteries, solar panels and solar roof tiles.</p>
