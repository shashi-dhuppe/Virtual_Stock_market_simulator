...
window.onload = function () {
	var chart = new CanvasJS.Chart("chartContainer",
	{
		...
		{        
			...
			name: "High",
			dataPoints: [
				{ x: new Date(2017,0,3), y: 52 },
				{ x: new Date(2017,1,3), y: 56 },
				{ x: new Date(2017,2,3), y: 51 },
				{ x: new Date(2017,3,3), y: 50 },
				{ x: new Date(2017,4,3), y: 47 },
				{ x: new Date(2017,5,3), y: 49 },
				{ x: new Date(2017,6,3), y: 52 },
				{ x: new Date(2017,7,3), y: 51 },
				{ x: new Date(2017,8,3), y: 50 },
				{ x: new Date(2017,9,3), y: 52 }
			]
		...
		{        
			...
			name: "Low",
			dataPoints: [
				{ x: new Date(2017,0,3), y: 46 },
				{ x: new Date(2017,1,3), y: 49 },
				{ x: new Date(2017,2,3), y: 48 },
				{ x: new Date(2017,3,3), y: 45 },
				{ x: new Date(2017,4,3), y: 46 },
				{ x: new Date(2017,5,3), y: 47 },
				{ x: new Date(2017,6,3), y: 50 },
				{ x: new Date(2017,7,3), y: 49 },
				{ x: new Date(2017,8,3), y: 47 },
				{ x: new Date(2017,9,3), y: 51},
			]
		}
		]         
	});
...
<div id="main">
	...
	<div class="col-md-8">
		<h1>Harley-Davidson Inc.</h1>
		<h3>Consumer Goods Company</h3>
		<p align="justify">Harley-Davidson, Inc. (H-D), or Harley, is an American motorcycle manufacturer, founded in Milwaukee, Wisconsin in 1903.
		One of two major American motorcycle manufacturers to survive the Great Depression (along with Indian), the company has survived numerous ownership arrangements, subsidiary 
		arrangements (e.g., Aermacchi 1974-1978 and Buell 1987-2009), periods of poor economic health and product quality, as well as intense global competition, to become one of the
		world's largest motorcycle manufacturers and an iconic brand widely known for its loyal following. There are owner clubs and events worldwide as well as a company-sponsored 
		brand-focused museum.</p>
		<div class="box" id="bord">
				<h2>Harley-Davidson Inc.</h2>
