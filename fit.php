...
window.onload = function () {
	var chart = new CanvasJS.Chart("chartContainer",
	{
		...
		{        
			...
			name: "High",
			dataPoints: [
				{ x: new Date(2017,0,3), y: 7 },
				{ x: new Date(2017,1,3), y: 5 },
				{ x: new Date(2017,2,3), y: 6 },
				{ x: new Date(2017,3,3), y: 7 },
				{ x: new Date(2017,4,3), y: 7 },
				{ x: new Date(2017,5,3), y: 6 },
				{ x: new Date(2017,6,3), y: 5 },
				{ x: new Date(2017,7,3), y: 5 },
				{ x: new Date(2017,8,3), y: 5 },
				{ x: new Date(2017,9,3), y: 7 }
			]
		...
		{        
			...
			dataPoints: [
				...
				{ x: new Date(2017,1,3), y: 4 },
				{ x: new Date(2017,2,3), y: 5 },
				{ x: new Date(2017,3,3), y: 6 },
				{ x: new Date(2017,4,3), y: 5 },
				{ x: new Date(2017,5,3), y: 5 },
				{ x: new Date(2017,6,3), y: 4 },
				{ x: new Date(2017,7,3), y: 4 },
				{ x: new Date(2017,8,3), y: 4 },
				{ x: new Date(2017,9,3), y: 5},
			]
		}
		]         
	});
...
<div id="main">
	...
	<div class="col-md-8">
		...
		<p align="justify">Fitbit is an American company headquartered in San Francisco, California, known for its products of the same name, which are activity trackers, 
		wireless-enabled wearable technology devices that measure data such as the number of steps walked, heart rate, quality of sleep, steps climbed, and other personal metrics 
		...
		The company was formally known as Healthy Metrics Research, Inc. until 2007.</p>
