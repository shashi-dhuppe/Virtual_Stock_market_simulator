...
window.onload = function () {
	var chart = new CanvasJS.Chart("chartContainer",
	{
		...
		{        
			...
			name: "High",
			dataPoints: [
				{ x: new Date(2017,0,3), y: 98 },
				{ x: new Date(2017,1,3), y: 97 },
				{ x: new Date(2017,2,3), y: 98 },
				{ x: new Date(2017,3,3), y: 97 },
				{ x: new Date(2017,4,3), y: 97 },
				{ x: new Date(2017,5,3), y: 99 },
				{ x: new Date(2017,6,3), y: 98 },
				{ x: new Date(2017,7,3), y: 98 },
				{ x: new Date(2017,8,3), y: 97 },
				{ x: new Date(2017,9,3), y: 99 }
			]
		...
		{        
			...
			name: "Low",
			dataPoints: [
				{ x: new Date(2017,0,3), y: 95 },
				{ x: new Date(2017,1,3), y: 96 },
				{ x: new Date(2017,2,3), y: 96 },
				{ x: new Date(2017,3,3), y: 94 },
				{ x: new Date(2017,4,3), y: 95 },
				{ x: new Date(2017,5,3), y: 96 },
				{ x: new Date(2017,6,3), y: 94 },
				{ x: new Date(2017,7,3), y: 95 },
				{ x: new Date(2017,8,3), y: 96 },
				{ x: new Date(2017,9,3), y: 95 },
				{ x: new Date(2017,10,3), y: 95 },
				{ x: new Date(2017,11,3), y: 94}
			]
		}
		]         
	});
...
<div id="main">
	...
	<div class="col-md-8">
		...
		<p align="justify">JPMorgan Chase & Co. is an American multinational banking and financial services holding company headquartered in New York City. It is the largest bank 
		in the United States, the world's sixth largest bank by total assets, with total assets of US$2.534 trillion, and the world's second most valuable bank by market 
		capitalization. It is also one of the largest asset management companies in the world with US$2.789 trillion in assets under management and US$23.469 trillion in assets 
		under custody and administration. It is a major provider of financial services, and according to Forbes magazine is the world's fourth largest public company based upon a 
		composite ranking. The hedge fund unit of JPMorgan Chase is the second largest hedge fund in the United States. The company was formed in 2000, when Chase Manhattan
		Corporation merged with J.P. Morgan & Co.</p>
