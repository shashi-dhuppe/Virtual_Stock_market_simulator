				...
				<div class="col-md-8" id="bord">
					<div class="col-md-6">
						...
						$sql = mysql_query("SELECT sid,no_of_shares, buy_cost,comp_id,comp_name,price
										...
										WHERE ".$name.".sid='".$sid."' AND ".$name.".sold=0");
								$no=1;		
					...
					<h3>Number of shares: <?php echo $no_of_shares; ?></h3><br>
					<h3>Cost of each share <?php echo $price; ?></h3><br>
					<h3>Total cost <?php echo $total; ?></h3><br>
					<a href="#myModal" data-toggle="modal" class="btn" id="myBtn"> Submit</a>
					</div>
					<div class="col-md-6">
						<img src="sell.gif" width="400" height="400">
					</div>
				</div>
		</div>		
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body" style="padding:40px 50px;">
       <form role="form" action="sell_2.php">
			<h4>Are you sure that you want to sell these shares?</h4>
			<?php echo '<input name=id type=hidden value='.$sid.'>' ?>
