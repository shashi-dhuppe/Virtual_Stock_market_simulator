...
window.onload = function () {
	var chart = new CanvasJS.Chart("chartContainer",
	{
		...
		{        
			...
			name: "High",
			dataPoints: [
				{ x: new Date(2017,0,3), y: 49 },
				{ x: new Date(2017,1,3), y: 50 },
				{ x: new Date(2017,2,3), y: 48 },
				{ x: new Date(2017,3,3), y: 48 },
				{ x: new Date(2017,4,3), y: 47 },
				{ x: new Date(2017,5,3), y: 49 },
				{ x: new Date(2017,6,3), y: 50 },
				{ x: new Date(2017,7,3), y: 50 },
				{ x: new Date(2017,8,3), y: 49 },
				{ x: new Date(2017,9,3), y: 48 }
			]
		...
		{        
			...
			dataPoints: [
				...
				{ x: new Date(2017,1,3), y: 46 },
				{ x: new Date(2017,2,3), y: 47 },
				{ x: new Date(2017,3,3), y: 45 },
				{ x: new Date(2017,4,3), y: 44 },
				{ x: new Date(2017,5,3), y: 47 },
				{ x: new Date(2017,6,3), y: 46 },
				{ x: new Date(2017,7,3), y: 47 },
				{ x: new Date(2017,8,3), y: 45 },
				{ x: new Date(2017,9,3), y: 46 },
				{ x: new Date(2017,10,3), y: 45 },
				{ x: new Date(2017,11,3), y: 44}
			]
		}
		]         
	});
...
<div id="main">
	...
	<div class="col-md-8">
		...
		<p align="justify">Morgan Stanley (NYSE: MS) is a financial services firm providing investment banking, securities, wealth management and investment management services. It 
		is headquartered at 1585 Broadway in the Morgan Stanley Building, Midtown Manhattan, New York City. With offices in more than 42 countries and more than 55,000 employees, 
		the firm's clients include corporations, governments, institutions and individuals.</p>
