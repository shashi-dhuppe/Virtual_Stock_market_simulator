...
window.onload = function () {
	var chart = new CanvasJS.Chart("chartContainer",
	{
		...
		{        
			...
			name: "High",
			dataPoints: [
				{ x: new Date(2017,0,3), y: 36 },
				{ x: new Date(2017,1,3), y: 35 },
				{ x: new Date(2017,2,3), y: 33 },
				{ x: new Date(2017,3,3), y: 31 },
				{ x: new Date(2017,4,3), y: 35 },
				{ x: new Date(2017,5,3), y: 34 },
				{ x: new Date(2017,6,3), y: 36 },
				{ x: new Date(2017,7,3), y: 33 },
				{ x: new Date(2017,8,3), y: 32 },
				{ x: new Date(2017,9,3), y: 34 }
			]
		...
		{        
			...
			name: "Low",
			dataPoints: [
				{ x: new Date(2017,0,3), y: 33 },
				{ x: new Date(2017,1,3), y: 32 },
				{ x: new Date(2017,2,3), y: 29 },
				{ x: new Date(2017,3,3), y: 27 },
				{ x: new Date(2017,4,3), y: 31 },
				{ x: new Date(2017,5,3), y: 33 },
				{ x: new Date(2017,6,3), y: 29 },
				{ x: new Date(2017,7,3), y: 27 },
				{ x: new Date(2017,8,3), y: 26 },
				{ x: new Date(2017,9,3), y: 25 },
				{ x: new Date(2017,10,3), y: 27 },
				{ x: new Date(2017,11,3), y: 28}
			]
		}
		]         
	});
...
<div id="main">
	...
	<div class="col-md-8">
		...
		<p align="justify">Synchrony Financial is a consumer financial services company headquartered in Stamford, Connecticut, United States. The company offers consumer financing
		products, including credit, promotional financing and loyalty programs, installment lending, and FDIC insured savings products through Synchrony Bank, its wholly owned 
		subsidiary.</p>
