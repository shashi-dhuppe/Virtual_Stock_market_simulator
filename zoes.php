...
window.onload = function () {
	var chart = new CanvasJS.Chart("chartContainer",
	{
		...
		{        
			...
			name: "High",
			dataPoints: [
				{ x: new Date(2017,0,3), y: 14 },
				{ x: new Date(2017,1,3), y: 15 },
				{ x: new Date(2017,2,3), y: 16 },
				{ x: new Date(2017,3,3), y: 15 },
				{ x: new Date(2017,4,3), y: 15 },
				{ x: new Date(2017,5,3), y: 16 },
				{ x: new Date(2017,6,3), y: 14 },
				{ x: new Date(2017,7,3), y: 14 },
				{ x: new Date(2017,8,3), y: 15 },
				{ x: new Date(2017,9,3), y: 16 }
			]
		...
		{        
			...
			name: "Low",
			dataPoints: [
				{ x: new Date(2017,0,3), y: 13 },
				{ x: new Date(2017,1,3), y: 14 },
				{ x: new Date(2017,2,3), y: 15 },
				{ x: new Date(2017,3,3), y: 14 },
				{ x: new Date(2017,4,3), y: 13 },
				{ x: new Date(2017,5,3), y: 15 },
				{ x: new Date(2017,6,3), y: 13 },
				{ x: new Date(2017,7,3), y: 13 },
				{ x: new Date(2017,8,3), y: 14 },
				{ x: new Date(2017,9,3), y: 15},
			]
		}
		]         
	});
...
<div id="main">
	...
	<div class="col-md-8">
		<h1>Zoe's Kitchen Inc.</h1>
		<h3>Consumer Goods Company</h3>
		<p align="justify">Zoës Kitchen is a fast casual restaurant chain headquartered in Plano, Texas, United States. Serving a menu of variety of chicken salad, pasta salad, 
		pitas and grilled chicken sandwiches, the chain has grown to include 203 locations across 17 states with plans to expand further. Zoës’ menu features Mediterranean-inspired 
		comfort food with made-from-scratch recipes using fresh ingredients. Kevin Miles (CEO), who joined Zoës in 2009, succeeded Greg Dollarhyde as president in March 2011.</p>
		<div class="box" id="bord">
				<h2>Zoe's Kitchen Inc.</h2>
