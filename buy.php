		...
		<div class="col-md-12">
				...
				<div class="col-md-8" id="bord">
					...
					$sql = mysql_query("SELECT *
						...
						?>
					<h2>Buy shares<h2><br>
					<h3>Name of the share: <?php echo $comp_name; ?></h3><br>
					<h3>Number of tickr: <?php echo $tickr; ?></h3><br>
					<h3>Number of domain: <?php echo $domain; ?></h3><br>
					<h3>Cost of each share <?php echo $price; ?></h3><br>
					<a href="#myModal" data-toggle="modal" class="btn btn-warning" id="myBtn"> Submit</a>
				</div>
		</div>		
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body" style="padding:40px 50px;">
       <form role="form" method="post" action="buy_2.php">
			<div class="form-group">
              <label for="u"><span class="glyphicon glyphicon-user"></span> No. of shares</label>
              <input type="text" class="form-control" id="u" name="u" placeholder="Enter No. of shares" required>
            </div>
			<h4>Are you sure that you want to buy these shares?</h4>
			<?php echo '<input name=id type=hidden value='.$bid.'>' ?>
			<button type="submit" name="login_btn" class="btn btn-success btn-block"><span class="glyphicon glyphicon-ok-circle"></span></button> 
	   </form>		
      </div>
