...
$res=mysql_query("SELECT sid,no_of_shares, buy_cost,comp_id,comp_name,price
										FROM ".$name."
      ...
      function drawChart() {
        ...
        var data = google.visualization.arrayToDataTable([
          ...
          <?php
			...
			{
				//echo "['".$row['comp_name']."',".$row['buy_cost']."],";
				echo "['".$row['comp_name']."',".$row['buy_cost']."*".$row['no_of_shares']."],";
			}
		  ?>
        ]);
...
<div id="main">
	...
	<div class="col-md-8" id="bord">
			<h2>Starting Investment: 10000</h2>
			<?php 		
				$result_c3=mysql_query("SELECT balance 
						...
						$c3= $row_c3['balance'];?>
				<h2>Available Cash: <?php echo 10000-$c3;?></h2>
				<?php
	...
	<div class="col-md-4" id="bord">
		...
		$result1=mysql_query("SELECT *
							...
							while($row=mysql_fetch_array($result1))
							{
								...
								$time=$row['time'];
							if ($sold==0)
								echo "<li> ".$no_of_shares." shares of ".$comp_n." are bought by ".$name." at ".$buy_cost." on ".$time.""."</li><br>";
							}
		$uname=$name.'buy';					
		$result1=mysql_query("SELECT *
							FROM ".$uname."
							...
							while($row=mysql_fetch_array($result1))
							{
								...
								$comp_n=$row['comp_name'];
								$time=$row['time'];
								echo "<li> ".$no_of_shares." shares of ".$comp_n." are sold by ".$name." at ".$sell_cost." on ".$time.""."</li><br>";
							}					
		?>
		<a href="transaction.php"><h3>View transactions of other users</h3></a>
		<img src="other_users.jpg" width="400" height="400">
	</div>
	</div>
<script>
function openNav() {
