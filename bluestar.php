...
window.onload = function () {
	var chart = new CanvasJS.Chart("chartContainer",
	{
		...
		{        
			...
			name: "High",
			dataPoints: [
				{ x: new Date(2017,0,3), y: 782 },
				{ x: new Date(2017,1,3), y: 765 },
				{ x: new Date(2017,2,3), y: 755 },
				{ x: new Date(2017,3,3), y: 790 },
				{ x: new Date(2017,4,3), y: 822 },
				{ x: new Date(2017,5,3), y: 810 },
				{ x: new Date(2017,6,3), y: 780 },
				{ x: new Date(2017,7,3), y: 760 },
				{ x: new Date(2017,8,3), y: 735 },
				{ x: new Date(2017,9,3), y: 750 }
			]
		...
		{        
			...
			name: "Low",
			dataPoints: [
				{ x: new Date(2017,0,3), y: 730 },
				{ x: new Date(2017,1,3), y: 741 },
				{ x: new Date(2017,2,3), y: 762 },
				{ x: new Date(2017,3,3), y: 800 },
				{ x: new Date(2017,4,3), y: 789 },
				{ x: new Date(2017,5,3), y: 767 },
				{ x: new Date(2017,6,3), y: 731 },
				{ x: new Date(2017,7,3), y: 701 },
				{ x: new Date(2017,8,3), y: 685 },
				{ x: new Date(2017,9,3), y: 710},
			]
		}
		]         
	});
...
<div id="main">
		...
		<ul class="nav navbar-nav">
			...
			<li class="dropdown">
				...
				<ul class="dropdown-menu">
					...
					<li><a href="#">Bank Of America Corp.</a></li>
					<li><a href="#">KeyCorp</a></li>
					<li><a href="#">Goldman Sachs Group Inc.</a></li>
				</ul>
			</li>
			<li class="dropdown">
				...
				<ul class="dropdown-menu">
					...
					<li><a href="#">Whirlpool Corporation</a></li>
					<li><a href="#">Fitbit Inc.</a></li>
					<li><a href="#">Zoe's Kitchen Inc.</a></li>
					<li><a href="#">Blue Star Ltd.</a></li>
					<li><a href="#">Harley-Davidson Inc.</a></li>
				</ul>
			</li>
			<li class="dropdown">
	...
	<div class="col-md-8">
		...
		<p align="justify">Blue Star Infotech Ltd, based in Mumbai, Bangalore, Santa Clara, New Jersey, London, Singapore, Malaysia, is a global provider of product development 
		services, enterprise solutions and services, travel technology solutions and testing services with operations in North America, Europe, UK, and India. It is part of the 
		US$700M Blue Star Group. They have service delivery centers in the United States, United Kingdom, India, Singapore and Malaysia. Blue Star Infotech is ranked in the list 
		of 2013 Global Services 100 companies as a leader Global IT and Business Process Outsourcing.</p>
		<div class="box" id="bord">
				...
				<?php
					$result_c3=mysql_query("SELECT price 
									FROM company 
									WHERE tickr='bluestarco'");
						while ($row_c3 = mysql_fetch_assoc($result_c3))
						$price= $row_c3['price'];
					?>BLUESTARCO=<?php echo $price?>
